...
public class TestApplication extends EndpointTest {
    ...
    public void testProvider() throws Exception {
        ...
        assertTrue("Description was not found.", provider.getDescription().contains("<h2>Spring Boot with WebSocket</h2>"));
        ...
        for (Dependency dependency : dependencies) {
            if (Dependency.Scope.PROVIDED.equals(dependency.getScope())) {
                assertTrue("groupId incorrect.", "net.wasdev.wlp.starters.springbootwebsocket".equals(dependency.getGroupId()));
